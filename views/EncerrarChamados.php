...
<head>
    <title>ADS | Encerrar Chamados</title>
...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #08253F; color: White;">
            <a class="navbar-brand text-white" href="/trabalho-ads-dsw-frontend/index.php">Anúbis - Engenharia de Automação</a>
        </nav>
    </header>
    <div class="container">
        <h1>Registro de Atendimento/Chamado - Eng. Automação</h1>
        <form method="post" action="/trabalho-ads-dsw-frontend/models/EncerrarChamadosModel.php" id="encerrarChamadoForm"
    ...
    <script src="/trabalho-ads-dsw-frontend/public/scripts/EncerrarChamados.js"></script>
</body>
