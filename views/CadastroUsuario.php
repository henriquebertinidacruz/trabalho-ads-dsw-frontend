...
<head>
    ...
    <title>ADS | Cadastro Usuário</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <link rel="icon" href="/public/images/trabalho-ads-dsw-frontend-engenharias-grupo-multi.png" type="image/x-icon">
    <link rel="stylesheet" href="/trabalho-ads-dsw-frontend/public/styles/visualizarChamados.css">
</head>
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="login-container">
                    ...
                    <form method="post" action="/trabalho-ads-dsw-frontend/controllers/CadastroUsuarioController.php">
