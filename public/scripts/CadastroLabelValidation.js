$(document).ready(function () {
    var table = $('#LabelValidationTable').DataTable({
        ...
        "ajax": {
            "url": "/trabalho-ads-dsw-frontend/controllers/CarregarCadastroLabelValidationController.php",
            "type": "GET"
        },
        "columns": [
            { "data": "ID" },
    ...
    $('#salvarBtn').on('click', function () {
        ...
        $.ajax({
            url: '/trabalho-ads-dsw-frontend/controllers/AtualizarCadastroLabelValidationController.php',
            type: 'POST',
            data: formData,
