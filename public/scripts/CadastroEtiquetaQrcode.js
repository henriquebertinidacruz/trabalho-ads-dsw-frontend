$(document).ready(function () {
    var table = $('#etiquetasTable').DataTable({
        ...
        "ajax": {
            "url": "/trabalho-ads-dsw-frontend/controllers/CarregarCadastroEtiquetasQrcodeController.php",
            "type": "GET"
        },
        "columns": [
            { "data": "id" },
    ...
    $('#atualizarForm').submit(function (event) {
        ...
        $.ajax({
            url: '/trabalho-ads-dsw-frontend/controllers/AtualizarCadastroEtiquetaQrcodeController.php',
            type: 'POST',
            data: formData,
